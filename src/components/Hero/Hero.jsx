                ...
                <div className="container pb-8 sm:pb-0">
                    <div className="grid grid-cols-1 sm:grid-cols-2 ">
                        ...
                        <div
                            ...
                            data-aos-once="true"
                            className="flex flex-col justify-center gap-4 sm:pt-0 text-center sm:text-left order-1 sm:order-1 mt-10 sm:mt-0 font-lobster"
                        >
                            ...
                            <div>
                                <button
                                    className="bg-gradient-to-r from-primary to-secondary hover:scale-105 duration-200 text-white py-2 px-4 rounded-md  font-poppins">
                                    Pedir ahora
                                </button>
                            </div>
                        </div>
